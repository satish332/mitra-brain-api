...
const fetchAndStoreDailyPrices = async () => {
  if (!FMP_KEY) { console.log('[prices] FMP_KEY not set — skipping'); return; }
  try {
    ...
    console.log('[prices] done — ok:', ok, 'skip:', skip);
  } catch (e) { console.error('[prices] fatal:', e.message); }
};

// Scheduler: 5:00 PM ET weekdays — fire once per calendar day
